...
- **4 条主线**：AI巨星出走与创业潮(3条) / 多模态与Agent基础设施(4条) / 资本博弈与地缘角力(5条) / 研究前沿(1篇论文)
- **13 条卡片** + 1 篇论文 + 补充资讯2条
- **16 个信源**
...
- **4 条主线**：大模型密集发布与开源浪潮(4条) / AI安全监管与模型越界(3条) / 资本博弈与产业落地(3条) / 研究前沿(1篇论文)
- **14 条卡片** + 1 篇论文 + 补充资讯4条
- **16 个信源**

## 上一期结构（2026-07-31）

- **4 条主线**：大模型价格战与自主进化(4条) / AI安全共识与联盟博弈(3条) / 算力超级周期与芯片财报(4条) / 产业政策与落地加速(3条)
- **14 条卡片** + 1 篇论文
- **16 个信源**

## 上一期结构（2026-07-30）

- **4 条主线**：AI安全震动与监管框架(4条) / 大模型开源与产品浪潮(4条) / 算力基建与芯片博弈(4条) / 具身智能与产业落地(4条)
- **16 条卡片** + 1 篇论文
- **18 个信源**
